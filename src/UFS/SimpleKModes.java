 ...
 * @throws Exception 
  ...
  public static void main (String[] argv) throws Exception {
	  ...
	  Instances newdata = new Instances(new FileReader(path));
	 ...
	 // SimpleKModes skm = new SimpleKModes();
	  ...
	  {
		  res[i] = skm.clusterInstance(data.instance(i));
	  }
	  
	  System.out.println(Arrays.toString(res));
	  
	  double ans = EvaluatedUFS.CA(newdata, res);
	   //double ans = EvaluatedUFS.CA(newdata, skm.getAssignments());
